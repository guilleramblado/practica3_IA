...
class AIPlayer: public Player{
    ...
    public:
        ...
        //comportamiento que equivale a tomar la decision que nos lleve al estado que nos asegure un mayor beneficio, usando poda alfa-beta
        void thinkMayorBeneficio(color &c_piece, int &id_piece, int &dice) const;
